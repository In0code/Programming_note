 ...
 * Generated at: 2023-10-10 03:25:43 UTC
...
public final class forward_005fa_jsp extends org.apache.jasper.runtime.HttpJspBase
    implements org.apache.jasper.runtime.JspSourceDependent,
                 org.apache.jasper.runtime.JspSourceImports {

  public java.lang.String getServletInfo() {
    return "데이터 처리 페이지- 화면을 만들지 않는다";
  }
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	list.add(new testVO("duam.png","카카오","http://http://daum.net"));
	list.add(new testVO("bootstrap.png","이젠 디자인하면 트위터 부트스트랩이죠잉",
			"http://getbootstrap.com"));
	
	String deathNote="초파리다죽는다오지마라";
	//0. 처리된 데이터를 뷰페이지로 보내기 위해 scope객체에 설정한다
	request.setAttribute("data", list);
	request.setAttribute("deathNote", deathNote);
